...
0,
1,0,0,0,47,0,47,0,9,8,72,250,124,0,80,0,
108,0,97,0,110,0,101,0,46,0,113,0,109,0,108,0,
...
Registry::Registry() {
        ...
        resourcePathToCachedUnit.insert(QStringLiteral("/Plane.qml"), &QmlCacheGeneratedCode::_0x5f__Plane_qml::unit);
